<template>
  <div class="nicklogin">
    <mt-header title="昵称登录">
      <router-link to="" @click.native="back" slot="left">
        <mt-button icon="back"></mt-button>
      </router-link>
      <router-link :to="{name:'mobilelogin'}" slot="right">
        <mt-button icon="">手机登录</mt-button>
      </router-link>
    </mt-header>
    <section>
      <div class="form">
        <div class="username">
          ...
          <input type="text" name="" placeholder="昵称/用户名(5-30位字符)" value="">
        </div>
        <div class="password">
          <i class="mintui mintui-mima"></i>
          <input type="text" name="" placeholder="输入密码" value="">
        </div>
      </div>
      <div class="login">
